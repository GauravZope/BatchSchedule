		...
		<table class="table table-striped table-hover  table-responsive alignCenter">
			...
			<tbody class="table-body">
				<c:forEach var="batchScheduleDTO" items="${batchScheduleDTOList}">
					<tr>
						<td>${batchScheduleDTO.batchCode}</td>
						...
						<td ><a href=" ${ deleteLink }${batchScheduleDTO.id}"><img class="viewIcon" src="${deleteIcon}"> </a></td>

					</tr>
				</c:forEach>
			</tbody>
			<thead class="table-head">
				<th> <a href=" ${ addLink }"><img class="viewIcon" style="height: 25px; width: 25px;" src="${addIcon}"></a></th>
